  ...
  class PaymentManager extends Actor {
    override def receive: Receive = {
      case AuthorizeCard(card) =>
        ...
        else Thread.sleep(4000); sender() ! PaymentAccepted
    }
  }
...
// used basically for Integration Test
/*
Recap
1. Use of EventFilters to intercept logs
2. intercept exceptions
3. Event filters are very useful for integration tests when it's hard to perform message based testing
 */
